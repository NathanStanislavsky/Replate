...
export function ListingEdit() {
    ...
    getListing(Number(id))
      .then((l) => {
        ...
        setForm({
          ...
          public_qty: l.public_qty,
          standard_price: Number(l.standard_price),
          ebt_price: l.ebt_price != null ? Number(l.ebt_price) : "",
          retail_value: Number(l.retail_value ?? 0),
          snap_eligible: l.snap_eligible,
          address: l.address ?? "",
        });
      })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateListing(listing.id, {
      ...
      ebt_price: form.ebt_price === "" ? undefined : Number(form.ebt_price),
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-6">{listing.item_name}</p>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({
                  ...f,
                  ebt_price: e.target.value === "" ? "" : Number(e.target.value),
                }))
              }
              className="w-full border border-gray-300 rounded-lg p-2"
